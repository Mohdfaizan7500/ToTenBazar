        ...
        return (
            <View style={styles.paymentSection}>
                ...
                <View style={styles.paymentRow}>
                    <Text style={styles.paymentLabel}>Total Items ({orderData.paymentSummary.totalItems})</Text>
                    <Text style={styles.paymentValue}>${orderData.paymentSummary.total}</Text>
                </View>
                <View style={styles.paymentRow}>
                    <Text style={styles.paymentLabel}>Delivery Fee</Text>
                    <Text style={styles.paymentValue}>${orderData.paymentSummary.deliveryFee}</Text>
                </View>
                <View style={styles.paymentRow}>
                    <Text style={styles.paymentLabel}>Discount</Text>
                    <Text style={styles.paymentValue}>-${orderData.paymentSummary.discount}</Text>
                </View>
                <View style={[styles.paymentRow, styles.totalRow]}>
                    <Text style={styles.totalLabel}>Total</Text>
                    <Text style={styles.totalValue}>${orderData.paymentSummary.total}</Text>
                </View>
            </View>
        )
    }
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.orderDetailsSection}>
                ...
                <View style={styles.detailRow}>
                    ...
                    <Text style={styles.addressValue}>"{orderData.deliveryAddress}"</Text>
                </View>
                <View style={styles.detailRow}>
                    <Text style={styles.detailLabel}>{orderData.date}</Text>
                    <Text style={styles.detailNote}>On behalf of the QR</Text>
                </View>
                <View style={styles.detailRow}>
                    <Text style={styles.detailLabel}>{orderData.deliveryDate}</Text>
                </View>
            </View>

            {/* Action Buttons */}
            <View style={styles.actionButtons}>
                <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate('HelpCenter')}>
